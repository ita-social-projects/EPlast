...
{
    public class GetCityMembersHandlerTest
    {
        private Mock<IMediator> _mockMediator;
        private GetCityMembersHandler _handler;
        private GetCityMembersQuery _query;
        ...
        public void SetUp()
        {
            ...
            _handler = new GetCityMembersHandler(_mockMediator.Object);
            _query = new GetCityMembersQuery(CityId);
        }

        [Test]
        public async Task GetCityMembersHandlerTest_ReturnsCityProfile()
        {
            //Arrange
            _mockMediator
        ...
        [Test]
        public async Task GetCityMembersHandlerTest_ReturnsNull()
        {
            //Arrange
            _mockMediator
                .Setup(m => m.Send(It.IsAny<GetCityByIdWthFullInfoQuery>(), It.IsAny<CancellationToken>()))
