...
{
    public class UnArchiveHandlerTest
    {
        private Mock<IRepositoryWrapper> _repoWrapper;
        private UnArchiveHandler _handler;

        [SetUp]
        public void SetUp()
        {
            _repoWrapper = new Mock<IRepositoryWrapper>();
            _handler = new UnArchiveHandler(_repoWrapper.Object);
        }
        ...
        public async Task ArchiveAsyncHandlerTest_ValidTest()
        {
            ...
            // Act
            await _handler.Handle(It.IsAny<UnArchiveCommand>(), It.IsAny<CancellationToken>());
