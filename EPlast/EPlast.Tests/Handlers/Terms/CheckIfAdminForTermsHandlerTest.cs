...
namespace EPlast.Tests.Handlers.TermsOfUse
{
    public class CheckIfAdminForTermsHandlerTest
    {
        private Mock<UserManager<User>> _userManager;
        private CheckIfAdminForTermsHandler _handler;
        private CheckIfAdminForTermsQuery _query;
        ...
        public void SetUp()
        {
            ...
            _handler = new CheckIfAdminForTermsHandler(_userManager.Object);
            _user = new User();
            _query = new CheckIfAdminForTermsQuery(_user);
        }
