$(document).ready(function () {
    ...
    $('#Upload-photo-clubAdmin').click(function (e) {
        let input: HTMLInputElement = <HTMLInputElement>document.getElementById("upload-file-clubAdmins");
    ...
    $('#save-editedClub').click((e: any) => {
        mistakeClubName2.hide();
        mistakeClubName.hide();
        mistakeClubDescription.hide();
        let input: HTMLInputElement = <HTMLInputElement>document.getElementById("clubName-clubAdmins");
        ...
        let input2: HTMLInputElement = <HTMLInputElement>document.getElementById("clubDescription-clubAdmins");
