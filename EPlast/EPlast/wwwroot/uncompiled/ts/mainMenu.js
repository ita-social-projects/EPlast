let profileListing = [
    ...
    ['<a class="text-light nav-link p-0" href="/Admin/UsersTable">Таблиця користувачів</a>',
        ...
        'Відзначення',
        'Кадра Виховників'],
    ['<a class="text-light nav-link p-0" href="/Documentation/CreateAnnualReportAsync">Подати річний звіт станиці</a>',
        '<a class="text-light nav-link p-0" href="/Documentation/ViewAnnualReportsAsync">Річні звіти</a>',
