let profileListing = [
    ...
    ['<a class="text-light nav-link p-0" href="/Admin/UsersTable">Таблиця користувачів</a>',
        ...
        'Відзначення',
        'Кадра Виховників'],
    ['<a class="text-light nav-link p-0" href="/AnnualReport/Create">Подати річний звіт станиці</a>',
        '<a class="text-light nav-link p-0" href="/AnnualReport/GetAll">Річні звіти</a>',
