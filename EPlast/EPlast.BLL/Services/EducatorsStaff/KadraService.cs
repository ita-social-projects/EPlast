...
namespace EPlast.BLL.Services.EducatorsStaff
{
    public class KadraService:IKadraService
    {
        ...
        {
                var deletedKadra = (await _repositoryWrapper.KVs.GetFirstOrDefaultAsync(d => d.ID == kadra_id));
        ...
        {
            var Kadras = _mapper.Map<IEnumerable<KadraVykhovnykiv>,IEnumerable<KadraVykhovnykivDTO>>(await _repositoryWrapper.KVs.GetAllAsync(c => c.User.Id == UserId));
            return Kadras;
        }
        ...
        public async Task<IEnumerable<KadraVykhovnykivDTO>> GetKVsWithKVType(int kvType_Id)
        {
            ...
            var KVs = _mapper.Map<IEnumerable<KadraVykhovnykiv>, IEnumerable<KadraVykhovnykivDTO>>(await _repositoryWrapper.KVs.GetAllAsync(k => k.KadraVykhovnykivType.ID == kvType_Id,
                include:
                source => source
                .Include(c => c.User)
                ));
