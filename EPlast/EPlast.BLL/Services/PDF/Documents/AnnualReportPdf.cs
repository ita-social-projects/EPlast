    ...
    public class AnnualReportPdf : PdfDocument
    {
        ...
        protected void DrawText(XGraphics gfx, PdfPage page)
        {
            ...
            additionalHeight = _annualReport.ImprovementNeeds == null
                ? 0
                : (_annualReport.ImprovementNeeds.Count(x => x == '\n') * BaseFontSize);
            var textArea = new XRect(column1_X, currentRowY, textAreaWidth, BaseFontSize + additionalHeight);
            ...
            currentRowY += rowHeight + additionalHeight;
            gfx.DrawLine(pen, lineStart, currentRowY, lineEnd, currentRowY);
            //////////////////////////////////////////////////////////
            currentRowY += rowHeight;
            ...
            additionalHeight = _annualReport.ImprovementNeeds == null
                ? 0
                : (_annualReport.ImprovementNeeds.Count(x => x == '\n') * BaseFontSize);
            textArea = new XRect(column1_X, currentRowY, textAreaWidth, BaseFontSize + additionalHeight);
            tf.DrawString((_annualReport.ImprovementNeeds != null ? $"{_annualReport.ImprovementNeeds}" : "Інформація відсутня"), font, XBrushes.Black, textArea, XStringFormats.TopLeft);
        }
    }
}
