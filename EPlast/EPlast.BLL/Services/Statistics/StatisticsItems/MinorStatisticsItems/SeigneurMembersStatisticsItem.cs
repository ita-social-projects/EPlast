...
{
    public class SeigneurMembersStatisticsItem : IStatisticsItem
    {
        public StatisticsItem GetValue(MembersStatistic membersStatistic)
        {
            return new StatisticsItem
            {
                Indicator = StatisticsItemIndicator.NumberOfSeigneurMembers,
                Value = (membersStatistic == null) ? 0 : membersStatistic.NumberOfSeigneurMembers
            };
        }
        ...
        public StatisticsItem GetValue(IEnumerable<MembersStatistic> membersStatistics)
        {
            ...
            {
                value += membersStatistic.NumberOfSeigneurMembers;
            }
            return new StatisticsItem
            {
                Indicator = StatisticsItemIndicator.NumberOfSeigneurMembers,
